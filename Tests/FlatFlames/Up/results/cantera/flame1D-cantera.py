...
print("calculations ...")
density_u = f.density[0]
density_b = f.density[1]
...
with open('ct-flamedata.csv', 'w', newline='') as file:
    ...
    writer.writerow(['unburnt-density', density_u])
    writer.writerow(['burnt-density', density_b])
    writer.writerow(['thermodynamic-expansion', thermodynamic_expansion])
    writer.writerow(['sL', laminar_flamespeed])
    writer.writerow(['lL', laminar_thermal_thickness])
